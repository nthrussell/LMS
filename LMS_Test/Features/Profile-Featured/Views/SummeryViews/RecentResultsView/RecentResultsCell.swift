...
class RecentResultsCell: UITableViewCell {
    ...
    func configure(date: String, sideA: String, sideAImage: UIImage, sideB: String, sideBImage: UIImage, result: String) {
        dateLabel.text = date
        sideAImageView.image = sideAImage
        sideATitleLabel.text = sideA
        sideBImageView.image = sideBImage
