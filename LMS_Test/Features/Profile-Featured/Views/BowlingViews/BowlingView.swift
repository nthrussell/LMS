...
class BowlingView: BindView<FeaturedViewModel>, UITableViewDelegate, UITableViewDataSource {
    ...
    private let rows: [[String]] = [
        ["Mohamed Cheikh", "445.3", "107", "31.53", "8.11", "4/5", "07", "09", "22"],
        ["Mohamed Cheikh", "445.3", "107", "31.53", "8.11", "4/5", "07", "09", "22"],
        ["Mohamed Cheikh", "445.3", "107", "31.53", "8.11", "4/5", "07", "09", "22"],
        ["Mohamed Cheikh", "445.3", "107", "31.53", "8.11", "4/5", "07", "09", "22"],
        ["Mohamed Cheikh", "445.3", "107", "31.53", "8.11", "4/5", "07", "09", "22"],
    ...
    override func setupViews() {
        ...
        tableView.register(BowlingTableViewCell.self, forCellReuseIdentifier: "BowlingCell")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "BowlingCell", for: indexPath) as? BowlingTableViewCell else {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let headerView = BowlingTableHeaderView()
        return headerView
    }
...
class BowlingTableHeaderView: UIView {
    private let labels: [UILabel] = [
        UILabel(), UILabel(), UILabel(), UILabel(), UILabel(),
        UILabel(), UILabel(), UILabel(), UILabel()
    ]
    private let titles = ["Name", "Overs", "Wkts", "Avg", "Eco", "Best", "3fa", "Nat's Rnk", "Wrld Rnk"]
...
class BowlingTableViewCell: UITableViewCell {
